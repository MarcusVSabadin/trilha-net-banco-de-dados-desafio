...
-- Tabela ElencoFilme (Com Chaves Estrangeiras)
CREATE TABLE ElencoFilme (
    ...
    CONSTRAINT FK_Elenco_Atores FOREIGN KEY (IdAtor) REFERENCES Atores(Id),
    CONSTRAINT FK_Elenco_Filmes FOREIGN KEY (IdFilme) REFERENCES Filmes(Id)
) ENGINE=InnoDB;

-- Tabela FilmesGenero (Com Chaves Estrangeiras)
CREATE TABLE FilmesGenero (
    Id INT AUTO_INCREMENT NOT NULL,
    IdGenero INT NULL,
    IdFilme INT NULL,
    CONSTRAINT PK_FilmesGenero PRIMARY KEY (Id),
    CONSTRAINT FK_FG_Generos FOREIGN KEY (IdGenero) REFERENCES Generos(Id),
    CONSTRAINT FK_FG_Filmes FOREIGN KEY (IdFilme) REFERENCES Filmes(Id)
) ENGINE=InnoDB;

-- Inserção de Dados (Atores)
-- No MariaDB, o AUTO_INCREMENT lida com IDs manuais sem precisar de SET IDENTITY_INSERT
...
(1, 'Ação'), (2, 'Aventura'), (3, 'Animação'), (4, 'Biografia'), 
(5, 'Comédia'), (6, 'Crime'), (7, 'Drama'), (8, 'Horror'), 
(9, 'Musical'), (10, 'Mistério'), (11, 'Romance'), (12, 'Suspense'), (13, 'Guerra');

-- Inserção de Dados (Elenco)
...
(1, 1, 22), (2, 2, 17), (3, 2, 3), (4, 3, 12), (5, 5, 11), 
(6, 6, 8), (7, 6, 13), (8, 7, 26), (9, 7, 28), (10, 7, 18), 
(11, 7, 21), (12, 8, 2), (13, 9, 23), (14, 10, 7), (15, 10, 27), 
(16, 10, 1), (17, 11, 14), (18, 12, 6), (19, 13, 4);
